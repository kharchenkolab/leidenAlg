...
#line 1 "src/core/io/gml-lexer.l"
/*
   IGraph library.
...
*/
#line 24 "src/core/io/gml-lexer.l"
...
YY_RULE_SETUP
#line 79 "src/core/io/gml-lexer.l"
{ /* comments ignored */ }
	YY_BREAK
case 2:
/* rule 2 can match eol */
YY_RULE_SETUP
#line 81 "src/core/io/gml-lexer.l"
{ return STRING; }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 82 "src/core/io/gml-lexer.l"
{ return NUM; }
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 83 "src/core/io/gml-lexer.l"
{ return KEYWORD; }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 84 "src/core/io/gml-lexer.l"
{
                          yyextra->depth++;
                          if (yyextra->depth >= 32) {
                            return ERROR;
...
case 6:
YY_RULE_SETUP
#line 92 "src/core/io/gml-lexer.l"
{
                          yyextra->depth--;
                          if (yyextra->depth < 0) {
                            return ERROR;
...
YY_RULE_SETUP
#line 100 "src/core/io/gml-lexer.l"
{ }
	YY_BREAK
case 8:
/* rule 8 can match eol */
YY_RULE_SETUP
#line 101 "src/core/io/gml-lexer.l"
{ /* other whitespace ignored */ }
	YY_BREAK
case YY_STATE_EOF(INITIAL):
#line 103 "src/core/io/gml-lexer.l"
{
                          if (yyextra->eof) {
                            yyterminate();
                          } else {
...
case 9:
YY_RULE_SETUP
#line 111 "src/core/io/gml-lexer.l"
{ return ERROR; }
	YY_BREAK
case 10:
YY_RULE_SETUP
