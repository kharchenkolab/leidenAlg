...
#line 1 "src/core/io/lgl-lexer.l"
/*
   IGraph library.
...
*/
#line 24 "src/core/io/lgl-lexer.l"
...
YY_DECL
{
	...
	{
#line 76 "src/core/io/lgl-lexer.l"
...
case 1:
YY_RULE_SETUP
#line 80 "src/core/io/lgl-lexer.l"
{ return HASH; }
	YY_BREAK
/* ------------------------------------------------whitespace------*/
case 2:
YY_RULE_SETUP
#line 83 "src/core/io/lgl-lexer.l"
{ }
	YY_BREAK
/* ---------------------------------------------------newline------*/
case 3:
...
YY_RULE_SETUP
#line 86 "src/core/io/lgl-lexer.l"
{ return NEWLINE; }
	YY_BREAK
/* ----------------------------------------------alphanumeric------*/
case 4:
YY_RULE_SETUP
#line 89 "src/core/io/lgl-lexer.l"
{ return ALNUM; }
	YY_BREAK
case YY_STATE_EOF(INITIAL):
#line 91 "src/core/io/lgl-lexer.l"
{ if (yyextra->eof) {
                       yyterminate();
                    } else {
                       yyextra->eof=1;
...
case 5:
YY_RULE_SETUP
#line 99 "src/core/io/lgl-lexer.l"
{ return ERROR; }
	YY_BREAK
case 6:
YY_RULE_SETUP
