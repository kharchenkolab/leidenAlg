...
/* Define to 1 if using the GNU Fortran compiler */
#undef HAVE_GFORTRAN
...
/* We don't care about thread-local storage in R */
#undef IGRAPH_THREAD_LOCAL

/* Define to 1 if you use the vendored mini-GMP library */
#undef INTERNAL_GMP
...
#undef STDC_HEADERS
#define HAVE_ISFINITE HAVE_DECL_ISFINITE
